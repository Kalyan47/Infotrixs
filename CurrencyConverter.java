...
public class CurrencyConverter {
     ...
     private static final String API_KEY = "\"https://api.exchangerate.host/latest\""; // place with your API key
...
public static void main(String[] args) {
    ...
    try{
        ...
        double exchangeRate = jsonResponse.getJSONObject( key: "rates").getDouble(targetCurrency); 
